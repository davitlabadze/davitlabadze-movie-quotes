        ...
        <div class="flex justify-center py-36">
            <div class="ml-10">
                <main class="container max-w-lg p-6 mx-auto bg-gray-400 border border-gray-200 rounded-xl">
                    ...
                    <form action="{{url('admin/post')}}" method="POST" class="mt-10" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-6">
                            <label class="block mb-2 text-xs font-bold text-gray-700 uppercase" for="text"> QUOTES_EN </label>
                            <input class="w-full p-2 border border-gray-400" type="text" name="quote_en" id="" />
                        ...
                        <div class="mb-6">
                            ...
                            <input class="w-full p-2 border border-gray-400" type="text" name="quote_ka" id="" />
