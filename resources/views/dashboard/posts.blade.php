            ...
            <div class="ml-10">
                <main class="max-w-lg p-6 mx-auto bg-gray-400 border border-gray-200 rounded-xl">
                    ...
                    <div class="mt-2 space-y-2">
                        ...
                        <h1 class="text-gray-100 front-bold-text-xl"><a href="http://localhost:8000/dashboard/posts">Posts</a></h1>
                        <h1 class=" front-bold-text-xl"><a href="http://localhost:8000/dashboard/categories">Categories</a></h1>
                    </div>
                    <hr class="mt-2">
                        ...
                        <tbody>
                          ...
                          <tr class="bg-white">
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                              <img src="/img/solder.jpg" width="64" height="64" alt="">
                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                          ...
                          <tr class="bg-white"> 
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                              <img src="/img/grapes.jpg" width="64" height="64" alt="">
                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                <a href="#" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            </td>
                          ...
                          <tr class="bg-white"> 
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                              <img src="/img/3.jpg" width="64" height="64" alt="">
                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                <a href="#" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            </td>
